...
def test_no_operator_recovery_route_exists_on_the_http_surface() -> None:
    ...
    # The buyer facing payment surface, in full. The two Razorpay paths joined it in Phase 1I:
    # one creates an order for a customer to pay against and one receives what the browser
    # reports afterwards. Nothing operator facing appears here, which is what the loop above is
    # for.
